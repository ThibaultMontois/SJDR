...
readJsonFile("../src/json/histoire.json", function(text) {
    ...
    document.getElementById("recit").innerHTML = '<div class="recit"><div id="bot" class="neutral">'+bot+'</div><p class="recit-text">'+data.etape1.histoire+"</p></div><div class='choose'><p id='1'>"+data.etape1.choix["0"]+"</p><p id='2'>"+data.etape1.choix["1"]+"</p><p id='3'>"+data.etape1.choix["2"]+"</p></div>";
});